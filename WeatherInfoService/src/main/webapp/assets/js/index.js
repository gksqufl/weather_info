$(function() {
                    ...
                    datasets:[
                        {
                            label:r.dt+" 연령대 별 확진",
                            data:confArr,
                            backgroundColor:["rgba(30, 85, 173, 0.5)"]
                        }
                    ]
                }
            });
                    ...
                    datasets:[
                        {
                            label:"성별 확진 비율",
                            data:confArr,
                            backgroundColor:["rgba(30, 100, 100, 0.5)", "rgba(100, 150, 100, 0.5)"]
                        }
                    ]
                }
            });
                    ...
                    datasets:[
                        {
                            ...
                            backgroundColor:["rgba(80, 85, 173, 0.5)", "rgba(150, 85, 173, 0.5)"]
                        }
                    ]
                }
            })
    ...
    $.ajax({
        ...
        success:function(r) {
            ...
            for(let i=0; i<r.data.length; i++) {
                regionArray.push(r.data[i].region);
                firstArray.push(r.data[i].firstCnt);
                secondArray.push(r.data[i].secondCnt);
            }
            ...
            let vaccineChart = new Chart(ctx3, {
                ...
                data:{
                    ...
                    },
                    {
                        label:"2차 접종현황",
                        data:secondArray,
                        backgroundColor:['rgba(250, 70, 100, 0.5)']
                    }]
                }
            });
        }
